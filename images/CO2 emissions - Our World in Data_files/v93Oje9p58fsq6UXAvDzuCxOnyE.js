;window.CloudflareApps=window.Eager=window.CloudflareApps||window.Eager||{};window.CloudflareApps=window.CloudflareApps||{};CloudflareApps.siteId="760edc6439752f7bf7d8ffe51eb3358d";CloudflareApps.installs=CloudflareApps.installs||{};;(function(){CloudflareApps.internal=CloudflareApps.internal||{};var errors=[];CloudflareApps.internal.placementErrors=errors;var errorHashes={}
...
return false;}})();;CloudflareApps.installs["3wzpx1qEuScS"]={appId:"XzVIEqe1R2kW",scope:{}};;CloudflareApps.installs["3wzpx1qEuScS"].options={"chrome":0,"firefox":0,"ie":8,"opera":0,"safari":0};;CloudflareApps.installs["kjwBTKQLSi55"]={appId:"lMxPPXVOqmoE",scope:{}};;CloudflareApps.installs["kjwBTKQLSi55"].options={"domain":"","id":"UA-42018644-1","showDomain":false};;if(CloudflareApps.matchPage(CloudflareApps.installs['kjwBTKQLSi55'].URLPatterns)){(function(i,s,o,g,r,a,m){i['GoogleAnalyticsObject']=r;i[r]=i[r]||function(){(i[r].q=i[r].q||[]).push(arguments)},i[r].l=1*new Date();a=s.createElement(o),m=s.getElementsByTagName(o)[0];a.async=1;a.src=g;m.parentNode.insertBefore(a,m)})(window,document,'script','//www.google-analytics.com/analytics.js','ga');};if(CloudflareApps.matchPage(CloudflareApps.installs['kjwBTKQLSi55'].URLPatterns)){(function(){var options=CloudflareApps.installs['kjwBTKQLSi55'].options
var domain=options.showDomain&&options.domain?options.domain:'auto'
if(!options.id)return
window.ga('create',options.id,domain)
window.ga('send','pageview')}())}(function(){var script = document.createElement('script');script.src = '/cdn-cgi/apps/body/9jt2E8amHhpjWVKm-usYmCuAPbY.js';document.head.appendChild(script);})();